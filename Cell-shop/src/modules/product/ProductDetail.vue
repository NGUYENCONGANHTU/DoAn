...
import { convertFormDataDetail } from "./constants";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const submitForm = () => {
      handleSubmit(async () => {
        try {
          const fomData = convertFormDataDetail(model);
          if (model.id) {
    ...
    watchEffect(() => {
        if(props.data){
            ...
            model.price = props.data.price,
            model.sale_price = props.data.sale_price,
            model.status = props.data.status,
            model.category_id = props.data.category_id,
            model.trademark_id = props.data.trademark_id,
