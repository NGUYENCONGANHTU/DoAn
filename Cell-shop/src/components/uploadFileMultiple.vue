<script setup lang='ts'>
   ...
   import { defineEmits, ref, defineProps } from "vue"
    ...
    const forInputValueRef = ref<HTMLButtonElement | null>(null)
    ...
    // delete IMG
    const handelDeleteIMG = (id: number) => {
        try {
  ...
  <div>
    <div class="cart">
        <label for="inputAddress" class="form-label fw-bold mt-3"
            >Upload - File - Multiple<span class="mx-1 text-danger">*</span></label
        >
        <div class="drag-area">
